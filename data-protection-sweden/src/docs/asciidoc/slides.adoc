...
Wird für alles benutzt: Handy-Vertrag, Fitnessstudio, Bankkonto, ...
...
Vereine und Unternehmen bekommen eine Organisationsnummer. 

Dafür ist das Bolagsverket verantwortlich.
--
...
[.fragment]
Fragt mich nicht, was mit 100-Jährigen ist
...
[NOTE.speaker]
--
Die letzten vier Stellen nennt man Kontrollsiffror.
--

=== 3. Wohnhaft und Telefonnummern

Wohnhaft wird beim https://www.skatteverket.se/[Skatteverket.se] gemeldet
...
[NOTE.speaker]
--
Vertragliche Telefonnummern sind automatisch registriert.

Prepaid SIMs haben nen Pfand (zuletzt 100 SEK), bekommt man bei Registrierung zurück.

Unternehmen haben meist einen anderen Firmensitz, auf den die Telefonnummer registriert ist.
--

=== 4. Beziehungsstatus

Verheiratet, Geschieden oder Ehevertrag? 

Steht im schwedischem Heiratsregister
...
Steuerlich keine Vorteile/Unterschied

Erbschaft, gemeinsames Eigentum bei Trennung, Sorgerecht, Adoptionsrecht
...
=== !
image::boring.jpg[scaledwidth=100%]
...
[NOTE.speaker]
--
In Schweden wird eine Immobiliensteuer erhoben aktuell 0,75% des steuerlichen Wertes, 
   max 7 812SEK für ein "kleinhaus" - Eigentum.
   
Für Mietwohnungen 1 337SEK, höchstens 0,3% vom Steuerwert.
--

=== 8. Zugelassene Fahrzeuge

Fahrzeuge und Boote werden beim https://transportstyrelsen.se[Transportstyrelsen] registriert
...
Gesamter Steuerkatalog kann erworben werden
...
Max 5 Anfragen gleichzeitig, wenn man zum Amt hingeht

Einzelaukuft kostet 39 Sek für. Gesamtkatalog 256sek ( 8 540 115 inkomstdeklarationer för 2018)

Norwegen: Bedenken, dass es von Einbrechern ausgenutzt werden kann, 
  führte dazu dass die gesuchte Personen über Anfragen informiert wird.
--
...
== !
image::example.jpg[scalewidth=100%]
...
Adresse mit dem Bild von ihrem Haus,

Man kann sich auch noch anzeigen lassen, wer sonst noch dort wohnt.

Wenn ich auf Vem är nyinflyttad klicke, sehe ich all neue Nachbarn in der Umgebung
--
...
[NOTE.speaker]
--
Johan Ivarsson ist neu in der Nachbarschaft
--
...
[NOTE.speaker]
--
Hier sieht man, dass meine Kusine bald 50 wird,.. 
...
[NOTE.speaker]
--
Zwei Dienstleistungen ausgewählt

Oberste ist einen Service um das Auto zuverkaufen.

Untere ist einen Schuldenkontrolle,
einfach die Telefonnummer eingeben und man
bekommt einen Schuldenbericht zugesendet.

Schulden können, KfZ Steuer oder Bußgelder sein.
--
...
Wer hätte damit absolut kein Problem?
--
...
* *Geheime Dokumente*: Sind nicht öffentlich einsehbar
...
[.steps]
 ...
 . Verhinderung von Straftaten oder strafrechtliche Verfolgung
...
. Verhinderung von Straftaten oder strafrechtliche Verfolgung ist gefährdet
. Inspektion-, Kontroll- oder Aufsichtstätigkeiten einer öffentlichen Institution sind gefährdet
 ...
 * Plattformen löschen alle Daten freiwillig

[NOTE.speaker]
--
 * Das Recht der Veröffentlichung der Daten haben sie durch ein sog. “publishing certificate” 
 * Firmen mit so einem Zertifikate sind nicht gezwungen persönliche Daten zu löschen. 
 ...
 * Geringsten Verkehrstoten in der EU
 * Hohe Happiness
 * Höchste Gesundheitserwartung

[.fragment]
Aber ist Offenheit wirklich die Ursache?

[NOTE.speaker]
--
Alle skandinavischen Länder sind unter den ersten 7 im Korruptions index

Absoluter Gender-Pay Gap in DE bei 21%

In 2018 waren es 324 tot insgesamt, 77 bei überholvorgängen. 25 Tote pro Millionen Einwohner in DE sind es 38 Tote
Brandenburg 57 und Sachsen 63 pro Millionen Einwohner. 

Happiness: Schweden auf Platz 9. wobei 1.Finnland, 2.Norway, 3. Denmark.. Deutschland auf Platz 15

Höchste Gesundheitserwartung - Lebensjahre, in denen ich gesund bin.
--

=== Schutz des Individuums vor der Gesellschaft
...
Vertraue ich den Behörden und der Allgemeinheit und sorge dafür, 
das Missbrauch aufgedeckt werden kann und Folgen hat?
...
Wie viel viel Vertrauen habt ihr gengenüber Fremden im Alltag?

Wir sind alle IT-ler und wer agile sein möchte, muss vertrauen können.

You build it you run it - DevOps - needs Trust?  
--
 ...
 * https://www.transportstyrelsen.se/sv/vagtrafik/statistik/Olycksstatistik/officiell-statistik-polisrapporterad/[Unfallstatisiken]
 * https://ec.europa.eu/germany/news/20180410-strassensicherheit_de[strassensicherheit]
